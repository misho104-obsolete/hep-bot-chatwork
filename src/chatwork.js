var CHATWORK_MESSAGE_API = function(roomId){ return 'https://api.chatwork.com/v2/rooms/' + roomId + '/messages'; };


function postChatwork(config, roomId, message) {
    var payload = {
        'body' : message,
    };
    var headers = {
    ...
    return UrlFetchApp.fetch(roomId, options);
}


function chatworkVerifySignature(config, e){
    var shaObj = new jsSHA('SHA-256', 'TEXT');
    shaObj.setHMACKey(config.chatwork_webhook_token, 'B64');
    shaObj.update(e.postData.contents);
...
// https://raw.githubusercontent.com/Caligatio/jsSHA/master/src/sha256.js bf02077e0325b9638e7fa6c72597cb12cc1a082b
/*
